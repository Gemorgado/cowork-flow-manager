  ...
  return <div className="space-y-6 animate-fade-in">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        {isLoading ? <>
            ...
            <OccupancyStats roomOccupancy={roomOccupancy} stationOccupancy={stationOccupancy} />
            <StatusLegend />
          </>}
      </div>
      ...
      <div className="mb-6">
        {isLoading ? <Skeleton className="h-[400px]" /> : <OccupancyVisualizationProvider>
            <OccupancyVisualizer rooms={rooms} workStations={workStations} currentFloor={currentFloor} />
          </OccupancyVisualizationProvider>}
      </div>

      <OccupancyTabs rooms={rooms} workStations={workStations} currentFloor={currentFloor} isLoading={isLoading} onAllocateFlexToFixed={handleConvertFlexToFixed} onDataChange={handleRefresh} />
