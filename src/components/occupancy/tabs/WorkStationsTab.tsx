...
export const WorkStationsTab: React.FC<WorkStationsTabProps> = ({
  ...
  return <CardContent>
      ...
      {flexCount > 0 && <div className="flex justify-end mb-4">
          
        </div>}
      
      {/* Unified grid for all station types */}
      <WorkStationGrid workStations={workStations} currentFloor={currentFloor} onAllocateFlexToFixed={onAllocateFlexToFixed} />
    </CardContent>;
};